...
//   const post = youtubePosts.find((p) => p.id === postId);

//   const { prevPost, nextPost } = useMemo(() => {
//     const sorted = [...youtubePosts].sort((a, b) => a.id - b.id);
...
//   const thumb = `https://img.youtube.com/vi/${post.youtubeId}/hqdefault.jpg`;
